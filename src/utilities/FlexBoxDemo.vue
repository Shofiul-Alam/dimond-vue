	...
	<div class="p-grid flexbox-demo">
		<div class="p-col-12">
			...
			<app-code lang="markup">
				&lt;div class="p-d-flex"&gt;Flex Container&lt;/div&gt; &lt;div
				class="p-d-inline-flex"&gt;Inline Flex Container&lt;/div&gt;
			</app-code>
			...
			<h6>Row</h6>
			<app-code lang="markup">
				&lt;div class="p-d-flex"&gt; &lt;div class="p-mr-2"&gt;Item
				1&lt;/div&gt; &lt;div class="p-mr-2"&gt;Item 2&lt;/div&gt;
				&lt;div&gt;Item 3&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				...
				class="p-mb-2"&gt;Item 1&lt;/div&gt; &lt;div
				class="p-mb-2"&gt;Item 2&lt;/div&gt; &lt;div&gt;Item
				3&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				&lt;div class="p-d-flex p-flex-column p-flex-md-row"&gt; &lt;div
				class="p-mb-2 p-mr-2"&gt;Item 1&lt;/div&gt; &lt;div
				class="p-mb-2 p-mr-2"&gt;Item 2&lt;/div&gt; &lt;div
				class="p-mb-2 p-mr-2"&gt;Item 3&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<h6>Customized</h6>
			<app-code lang="markup">
				&lt;div class="p-d-flex"&gt; &lt;div class="p-mr-2
				p-order-3"&gt;Item 1&lt;/div&gt; &lt;div class="p-mr-2
				p-order-1"&gt;Item 2&lt;/div&gt; &lt;div class="p-mr-2
				p-order-2"&gt;Item 3&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				&lt;div class="p-d-flex"&gt; &lt;div class="p-mr-2 p-order-3
				p-order-md-2"&gt;Item 1&lt;/div&gt; &lt;div class="p-mr-2
				p-order-1 p-order-md-3"&gt;Item 2&lt;/div&gt; &lt;div
				class="p-mr-2 p-order-2 p-order-md-1"&gt;Item 3&lt;/div&gt;
				&lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				&lt;div class="p-d-flex"&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 1&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 2&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 3&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 4&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 5&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 6&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<h6>Wrap</h6>
			<app-code lang="markup">
				&lt;div class="p-d-flex p-flex-wrap"&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 1&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 2&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 3&lt;/div&gt; &lt;div class="p-mr-2
				p-mb-2"&gt;Item 4&lt;/div&gt; &lt;div class="p-mr-2
			...
			<h6>Wrap Reverse</h6>
			<app-code lang="markup">
				&lt;div class="p-d-flex p-flex-wrap-reverse"&gt; &lt;div
				class="p-mr-2 p-mb-2"&gt;Item 1&lt;/div&gt; &lt;div
				class="p-mr-2 p-mb-2"&gt;Item 2&lt;/div&gt; &lt;div
				class="p-mr-2 p-mb-2"&gt;Item 3&lt;/div&gt; &lt;div
				class="p-mr-2 p-mb-2"&gt;Item 4&lt;/div&gt; &lt;div
				class="p-mr-2 p-mb-2"&gt;Item 5&lt;/div&gt; &lt;div
				class="p-mr-2 p-mb-2"&gt;Item 6&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<h6>Between</h6>
			<app-code lang="markup">
				&lt;div class="p-d-flex p-jc-between"&gt; &lt;div&gt;Item
				1&lt;/div&gt; &lt;div&gt;Item 2&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				...
				class="p-mr-2"&gt;Item 1&lt;/div&gt; &lt;div&gt;Item
				2&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<h6>Start</h6>
			<app-code lang="markup">
				&lt;div class="p-d-flex p-ai-start"&gt; &lt;div class="p-mr-2"
				style="height:100px"&gt;Item 1&lt;/div&gt; &lt;div
				style="height:50px"&gt;Item 2&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<h6>Center</h6>
			<app-code lang="markup">
				&lt;div class="p-d-flex p-ai-center"&gt; &lt;div class="p-mr-2"
				style="height:100px"&gt;Item 1&lt;/div&gt; &lt;div
				style="height:50px"&gt;Item 2&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				&lt;div class="p-d-flex" style="height: 150px;"&gt; &lt;div
				class="p-mr-2 p-as-start"&gt;Start&lt;/div&gt; &lt;div
				class="p-mr-2 p-as-center"&gt;Center&lt;/div&gt; &lt;div
				class="p-mr-2 p-as-end"&gt;End&lt;/div&gt; &lt;div class="p-mr-2
				p-as-stretch"&gt;Stretch&lt;/div&gt; &lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				&lt;div class="p-d-flex p-p-3 card"&gt; &lt;button pButton
				pRipple type="button" icon="pi pi-check"
				class="p-mr-2"&gt;&lt;/button&gt; &lt;button pButton pRipple
				type="button" icon="pi pi-trash"
				class="p-button-danger"&gt;&lt;/button&gt; &lt;button pButton
				pRipple type="button" icon="pi pi-search" class="p-ml-auto
				p-button-help"&gt;&lt;/button&gt; &lt;/div&gt;
			</app-code>
			...
			<app-code lang="markup">
				...
				&lt;div&gt;Item 1&lt;/div&gt; &lt;div class="p-mt-auto"&gt;Item
				2&lt;/div&gt; &lt;/div&gt; ;
			</app-code>
