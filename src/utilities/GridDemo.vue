<template>
    <div class="flexgrid-demo">
        ...
        <h5>Dynamic</h5>
        <Button icon="pi pi-plus" title="Add Column" @click="addColumn()" :disabled="columns.length === 20" class="p-mr-2 p-ripple"></Button>
        <Button icon="pi pi-minus" title="Remove Column" @click="removeColumn()" :disabled="columns.length === 1"></Button>

        <div class="p-mt-2">
            <transition-group name="visible" tag="div" class="p-grid">
                <div class="p-col" v-for="(col, i) of columns" :key="col">
