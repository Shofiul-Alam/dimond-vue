					...
					<div class="widget-timeline">
						...
						<div class="timeline-event">
							...
							<div class="timeline-event-detail">
								...
								<strong>new question</strong> about your
								product.
							</div>
						</div>
						<div class="timeline-event">
					...
					<div class="widget-chat">
						<ul>
							<li class="message-from">
								...
								/>
								<div>
									Retro occupy organic, stumptown shabby chic
									pour-over roof party DIY normcore.
								</div>
							</li>
							<li class="message-own">
								...
								/>
								<div>
									Actually artisan organic occupy, Wes
									Anderson ugh whatever pour-over gastropub
									selvage.
								</div>
							</li>
							<li class="message-from">
								...
								/>
								<div>
									Chillwave craft beer tote bag stumptown
									quinoa hashtag.
								</div>
							</li>
							<li class="message-own">
								...
								/>
								<div>
									Dreamcatcher locavore iPhone chillwave,
									occupy trust fund slow-carb distillery art
									party narwhal.
								</div>
							</li>
						</ul>
					...
					<div class="p-grid">
						<div class="p-col-12 p-md-6 p-lg-3">
							<div class="card widget-feature-box">
								...
								<h2>Responsive</h2>
								<span
									>Nam non ligula sed urna malesuada lacinia.
									Aliquam sed viverra ipsum.</span
								>
							</div>
						</div>
						<div class="p-col-12 p-md-6 p-lg-3">
