        ...
        <div class="p-col-12 p-md-6">
            ...
            <div class="card">
                ...
                <div class="p-formgroup-inline">
                    ...
                    <Button class="p-ripple" type="button" label="Submit"></Button>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="p-fluid p-formgrid p-grid">
                    ...
                    <div class="p-field p-col-12">
                        ...
                        <Textarea id="address" type="text" rows="4"></Textarea>
                    </div>
                    <div class="p-field p-col-12 p-md-6">
                    ...
                    <div class="p-field p-col-12 p-md-3">
                        ...
                        <Dropdown inputId="state" :options="states" v-model="selectedState" placeholder="Select" optionLabel="name"></Dropdown>
                    </div>
                    <div class="p-field p-col-12 p-md-3">
