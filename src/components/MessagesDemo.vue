    ...
    <div class="p-grid">
        ...
        <div class="p-col-12 p-lg-8">
            <div class="card">
                ...
                <div class="p-mt-4">
                    <InputText type="text" placeholder="Username" class="ng-dirty ng-invalid p-invalid p-mr-2" />
                    <InlineMessage severity="error">Field is required</InlineMessage>
                </div>

                <div class="p-mt-4">
                    <InputText type="text" placeholder="Email" class="ng-dirty ng-invalid p-invalid p-mr-2" />
