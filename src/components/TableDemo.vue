    ...
    <div class="p-grid table-demo">
        ...
        <div class="p-col-12">
            <div class="card">
                ...
                <DataTable ref="dt" :value="customer1" :selection.sync="selectedCustomers1" dataKey="id" class="p-datatable-customers" :rowHover="true" :rows="10" :paginator="true" :filterDelay="0" :filters="filters1">
                    <template #header>
                        <div class="table-header">
                            Customers
                            <span class="p-input-icon-left">
                                <i class="pi pi-search"></i>
                                <InputText type="text" v-model="filters1['global']" placeholder="Global Search" />
                            </span>
                        </div>
                    </template>
                    ...
                    <Column field="country.name" header="Country" sortable sortField="country.name">
                        <template #body="slotProps">
                            <img src="assets/demo/flags/flag_placeholder.png" :class="'flag flag-' + slotProps.data.country.code" width="30" />
                            <span class="image-text" style="margin-left: 0.5em; vertical-align: middle">{{ slotProps.data.country.name }}</span>
                        </template>
                    </Column>

                    <Column field="representative.name" header="Representative" sortable sortField="representative.name">
                        <template #body="slotProps">
                            ...
                            <span class="image-text" style="margin-left: 0.5em; vertical-align: middle">{{ slotProps.data.representative.name }}</span></template
                        >
                    </Column>
        ...
        <div class="p-col-12">
            <div class="card">
                ...
                <DataTable ref="dtc" :value="customer2" :selection="selectedCustomers2" dataKey="id" selectionMode="single" class="p-datatable-customers p-datatable-gridlines p-datatable-striped p-datatable-sm"
                    :filterDelay="0" :filters="filters2" :globalFilterFields="['name', 'country.name', 'representative.name', 'status']" :paginator="true" :rows="10">
                    <template #header>
                        <div class="table-header">
                            Customers
                            <span class="p-input-icon-left">
                                <i class="pi pi-search"></i>
                                <InputText type="text" v-model="filters2['global']" placeholder="Global Search" />
                            </span>
                        </div>
                    </template>
                    ...
                    <Column field="representative.name" header="Representative" sortable>
                        <template #body="slotProps">
                            <span class="p-column-title">Representative</span>
                            <img :alt="slotProps.data.representative.name" :src="'assets/demo/images/avatar/' + slotProps.data.representative.image" width="32" style="vertical-align: middle" />
                            <span class="image-text" style="margin-left: 0.5em; vertical-align: middle">{{ slotProps.data.representative.name }}</span>
                        </template>
                    </Column>
        ...
        <div class="p-col-12">
            <div class="card">
                <h4>Row Expand</h4>
                <DataTable :value="products" dataKey="name" :expandedRows.sync="expandedRows" @row-expand="onRowExpand" @row-collapse="onRowCollapse">
                    <template #header>
                    ...
                    <Column header="Image">
                        <template #body="slotProps">
                            <img :src="'assets/demo/images/product/' + slotProps.data.image" :alt="slotProps.data.name" width="100" class="p-shadow-4" />
                        </template>
                    </Column>
                    ...
                    <template #expansion="slotProps">
                        <div class="p-p-3">
                            <DataTable :value="slotProps.data.orders" dataKey="id">
                                ...
                                <template #empty>There are no order for this product yet.</template>
                            </DataTable>
                        </div>
                    </template>
                </DataTable>
            ...
            <div class="card">
                ...
                <DataTable :value="customer3" rowGroupMode="subheader" groupRowsBy="representative.name" sortMode="single" sortField="representative.name" :sortOrder="1">
                    ...
                    <Column field="country" header="Country">
                        <template #body="slotProps">
                            <img src="assets/demo/flags/flag_placeholder.png" :class="'flag flag-' + slotProps.data.country.code" width="30" />
                            <span style="margin-left: 0.5em; vertical-align: middle" class="image-text">{{ slotProps.data.country.name }}</span>
                        </template>
                    </Column>
                    ...
                    <template #groupheader="slotProps">
                        <img :alt="slotProps.data.representative.name" :src="'assets/demo/images/avatar/' + slotProps.data.representative.image" width="32" style="vertical-align: middle" />
                        <span style="margin-left: 0.5em; vertical-align: middle" class="image-text p-text-bold p-ml-2">{{ slotProps.data.representative.name }}</span>
                    </template>
