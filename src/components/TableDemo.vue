	...
	<div class="p-grid">
		...
		<div class="p-col-12">
			<div class="card">
				<h4>Row Expand</h4>
				<Toast />
				<DataTable :value="products" class="p-datatable-customers row-expand-demo" v-model:expandedRows="expandedRows" dataKey="id" @row-expand="onRowExpand" @row-collapse="onRowCollapse">
					<template #header>
