		...
		menu: [ 
			...
			{ separator: true }, 
			{
				...
				items: [ 
					...
					{label: "Media", icon: "pi pi-fw pi-bars", to: "/uikit/media"},
...
$transitionDuration:.2s !default; $animationDuration:.4s !default;
$animationTimingFunction:cubic-bezier(.05,.74,.2,.99) !default; 
$letterSpacing:normal !default; $borderRadius:4px !default; 
